...
resource "azurerm_storage_account" "sg1" { 
 name      =  "csestologovaleria" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
...
resource "azurerm_storage_account" "sg2" { 
 name      =  "csestologsvaleria" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
 resource_group_name   =  var.rg_name
 location     =  var.location
 # Performance tier: Standard (HDD-backed)
 account_tier    =  "Standard" 
...
name    =  "sqlservervaleria" # add your name to make it unique. Can only consist of lowercase letters and numbers, and must be between 3 and 24 characters long.
